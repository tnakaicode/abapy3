...
plt.clf()
plt.title(
    'Hollomon tensile behavior: $n = {0:.2f}$, $\sigma_y / E = {1:.2e}$'.format(n, sy / E))
...
plt.xticks([0., sy / E, eps_max], ['$0$', '$\epsilon_y$',
                                   '$\epsilon_{max}$'], fontsize=16.)
plt.yticks([0., sy, sigma_max1], [
           '$0$', '$\sigma_y$', '$\sigma_{max}$'], fontsize=16.)
plt.grid()
